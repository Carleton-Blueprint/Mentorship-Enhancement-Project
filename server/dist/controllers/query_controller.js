...
const findMatches = async () => {
    return await (0, prismaClient_1.withPrisma)(async (prisma) => {
        ...
        await prisma.$transaction(Array.from(mentorPairings.entries()).map(([mentorId, count]) => prisma.mentor.update({
